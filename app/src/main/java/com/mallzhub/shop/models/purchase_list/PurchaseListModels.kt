package com.mallzhub.shop.models.purchase_list
...
data class PurchaseListResponseData(val id: Int?, val merchant_id: Int?, val vendor_id: Int?,
                          ...
                          val details: List<PurchaseListDetails>?, val vendor: Vendor?, var isExpanded: Boolean = false)
...
data class PurchaseListDetails(val id: Int?, val purchase_id: Int?, val product_id: Int?,
                             ...
                             val updated_at: String?, val merchant_id: Int?, val product: Product?)

data class Links(val first: String?, val last: String?, val prev: Any?, val next: Any?)

data class Meta(val current_page: Int?, val from: Int?, val last_page: Int?, val path: String?,
                val per_page: Int?, val to: Int?, val total: Int?)

data class Total(val amount: Double?, val vat: Double?, val discount: Double?, val total: Double?)
